...
NOTE = (
    ...
    'minimal subtraction (MS-bar).  beta and Z_lambda are in the '
    ...
    'that leave a structure\'s tensor unchanged and orbit = 24/stab the number '
    'of distinct labellings.  (Z_lambda here is orbit times smaller than the '
    'coefficient of Tbar, the average over all 24 permutations.)  gamma_phi is '
